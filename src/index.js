...
function makeImg(obj) {
  obj.forEach( link => {
    ...
    imgLink.src = link.imageURL
    imgLink.style.width = '20em'
    console.log(imgLink)
    contain.append(imgLink)
    return imgLink
  })
...
function makePanel(/* what data does the panel need? */obj) {
...
panelContent.innerHTML = obj.content
